        ...
        public static void Initialize(YourTourContext context)
        {
            ...
            var tour = new Tour[]
            {
                ...
                new Tour{Code="T002", Tentour="Tour Đầm Ô Loan", Diadiemkhoihanh="TP Hồ Chí Minh",
                    ...
                    Lichtrinh="/docs/lichtrinh/template_ctrinhtour_bluesky.pdf", Mota="Một tour du lịch tuyệt vời đi qua các điểm đến nổi tiếng", Loaitour="Trong nước", TenHDV="Nguyễn Văn B", Songuoi=9, Trangthai = "còn chỗ", Tournoibat=1},
                new Tour{Code="T003", Tentour="Tour Tây An Cổ Tự", Diadiemkhoihanh="TP Hồ Chí Minh",
                    ...
                    Lichtrinh="/docs/lichtrinh/template_ctrinhtour_bluesky.pdf", Mota="Một tour du lịch tuyệt vời đi qua các điểm đến nổi tiếng", Loaitour="Trong nước", TenHDV="Nguyễn Văn A", Songuoi=9, Trangthai = "còn chỗ"},
                new Tour{Code="T004", Tentour="Miếu Bà Chúa Xứ", Diadiemkhoihanh="TP Hồ Chí Minh",
                    ...
                    Lichtrinh="/docs/lichtrinh/template_ctrinhtour_bluesky.pdf", Mota="Một tour du lịch tuyệt vời đi qua các điểm đến nổi tiếng", Loaitour="Trong nước", TenHDV="Nguyễn Văn B", Songuoi=9, Trangthai = "còn chỗ"}
